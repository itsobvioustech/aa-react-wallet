  ...
  return (
    <div>
        <Alert show={show} variant='secondary'>
          ...
          <p>
            This is a demo of an ERC4337 wallet implemented with <Alert.Link href="https://developer.apple.com/passkeys/">PassKeys</Alert.Link>. This should work on any modern browser
          ...
          <p>
            ...
            <ul>
              ...
              <li>Send some native token to another address of yours to deploy the contracts.</li>
          ...
          <p>
            Gory internal details and the codebase powering this coming soon in a blog post <Alert.Link href="https://www.obvious.technology/blogs">from Obvious</Alert.Link>.
          </p>
        </Alert>
      <div className="App">
        <CheckWebAuthn />
